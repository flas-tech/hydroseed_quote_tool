...
function getSettings() {
  return {
    fuelCost: parseFloat(localStorage.getItem("fuelCost") || 4.25),      // national avg diesel
    laborRate: parseFloat(localStorage.getItem("laborRate") || 25),     // avg skilled labor
    truckMPG: parseFloat(localStorage.getItem("truckMPG") || 10),       // diesel truck loaded
    equipmentHourlyRate: parseFloat(localStorage.getItem("equipmentHourlyRate") || 85), // avg rental rate
